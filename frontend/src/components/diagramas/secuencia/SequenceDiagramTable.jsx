...
export default function SequenceDiagramTable({
  diagrams,
  onView,
  onEdit,
  onDelete,
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-gradient-to-r from-slate-50 to-slate-100">
        <h3 className="font-semibold text-slate-700">Diagramas de Secuencia</h3>
        <Button
          onClick={onCreateNew}
      ...
      {diagrams.length === 0 ? (
        <div className="px-6 py-12 text-center">
          <p className="text-slate-500 mb-4">No hay diagramas de secuencia aún</p>
          <Button
            onClick={onCreateNew}
            variant="outline"
            className="mx-auto"
